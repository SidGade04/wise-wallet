...
export default function Login() {
  // Fixed: Only use properties that exist in your auth store
  ...
  // Fixed: Use 'loading' instead of 'isLoading'
  if (loading) {
    return (
                ...
                <Tabs defaultValue="login" className="w-full">
                  ...
                  <TabsContent value="login" className="space-y-3 mt-0">
                    <form onSubmit={handleEmailLogin} className="space-y-3">
                      ...
                      <Button type="submit" className="w-full h-9" disabled={authLoading}>
                        {authLoading ? (
                          <>
